...
public class Config {
	...
	public static final String Public_Info = ResPath_Root + "Public_Info_Rel\\";
	...
	public static final int TRAIN_ID_SIZE = 160;
	public static final int LEARN_ID_SIZE = 120;
	public static final int[] TRAIN_ID_SIZE_ARR = {160/*,120,80,40*/};//每类用户用于训练的ID数量。
	...
	public static final float DF_threshold = 0.9f;//取CHI值排在前50%的特征
	public static final boolean DF_FLAG = false;//是否使用DF筛选特征
	public static final boolean TFIDF_FLAG = true;//是否使用TFIDF表示特征,false时只用tf,true用tfidf
	...
	static{
		...
		//CLASSIFERS.add("Feature_UserInfo\\TagConVec");
		...
		//CLASSIFERS.add("Feature_Relation\\VFolNewType");
		//CLASSIFERS.add("Feature_Relation\\VFolType");
		//CLASSIFERS.add("Feature_Relation\\VFolType_BaiKeExpand25");
		//CLASSIFERS.add("Feature_Relation\\LDAVFriTopic");
		...
		//CLASSIFERS.add("Feature_SRC\\LDASrcTopic");
		...
		//CLASSIFERS.add("Feature_SRC\\AppNewType2");
