...
public class Predict {
	...
	public static void main(String args[]) throws InterruptedException, IOException{
		//String[] classifers = {"Simple_Self+SFriAvgVec_p2cbown5wcr200l100i15_Train+Test"};
	...
	public static void singleGetF1(String dir, int s, int n,String test_id_file,String result_file) throws IOException {
		...
		for(int i=0;i<n;i++){//train
			...
			GetResult.getPredictRes(path,"\\"+result_file+"_"+Config.CLASSIFIER_TYPE+".txt",testing_id,id_predict_res,1);
		...
		if(isAverage){
			average1 /= n;
			average2 /= n;
			SaveInfo.res_log(Config.ResPath+dir+"---"+Config.CLASSIFIER_TYPE+" MicroF1Score average="+average1,false);
			SaveInfo.res_log(Config.ResPath+dir+"---"+Config.CLASSIFIER_TYPE+" MacroF1Score average="+average2,false);
			SaveInfo.option_log(Config.ResPath+dir+"---"+Config.CLASSIFIER_TYPE+" MicroF1Score average="+average1);
			SaveInfo.option_log(Config.ResPath+dir+"---"+Config.CLASSIFIER_TYPE+" MacroF1Score average="+average2);
		}
	}
